...
- **verb**: ****to depart secretly and hide oneself
...
- **verb**: to corrupt, debase, or make impure by the addition of a foreign or inferior substance or element
...
- **noun**: a state of disorder due to absence or nonrecognition of authority.
...
- **adjective**: (of a country or region) having the freedom to govern itself or control its own affairs.
...
- **verb**: provide (a building or structure) with projecting supports built against its walls.
...
- like music taste being eclectic and catholic: ranging from Mali and Mongolia
...
- **verb**: (of a fluid, especially blood) change to a solid or semisolid state.
...
- **noun**: a collection of concise but detailed information about a particular subject, especially in a book or other publication.
...
- **adjective**: inclined to agree with others or obey rules, especially to an excessive degree; acquiescent.
- *a compliant labor force*
- excessive compliance could be obsequious
...
- **verb**: cause surprise or confusion in (someone), especially by acting against their expectations.
...
- **noun**: An action that violates a law, treaty, or other ruling.
...
- **verb**: to drain of emotional or intellectual vitality
...
- **adjective**: inspiring love or affection
...
- **noun**: a state off deep-seated ill-will
...
- **adjective**: not serious, as in something intended to be humorous or amusing
...
- **adjective**: ancient
- *Most workout are young, fit people, whereas most yoga gurus are **hoary** men with long white beards.*
...
- **noun**: a behavioral attitude that is distinctive and peculiar to an individual
...
- **adjective**: necessarily or demonstrably true; impossible to deny or disapprove
...
- **adjective**: of ideas or attitudes, inflexible, old-fashioned
...
- **adjective**: smug and ignorant towards artistic
...
- *After losing everything in a fire, Tim decided to live in **spartan** conditions, sleeping on the floor and owning as little furniture as possible.*

Spurious:

- **adjective**: plausible but false
- argument would be based on an illegitimate set of reasons
...
- Me when I am trying to explain something and I go in many different directions that ultimately confuses my audience and is difficult to comprehend
